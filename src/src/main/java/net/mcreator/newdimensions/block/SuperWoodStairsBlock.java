...
public class SuperWoodStairsBlock extends NewdimensionsModElements.ModElement {
	@ObjectHolder("newdimensions:super_wood_stairs")
	public static final Block block = null;
	public SuperWoodStairsBlock(NewdimensionsModElements instance) {
		super(instance, 208);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("super_wood_stairs");
		}
