...
public class DiamondDimensionBiomeBiome extends NewdimensionsModElements.ModElement {
	public static Biome biome;
	public DiamondDimensionBiomeBiome(NewdimensionsModElements instance) {
		super(instance, 32);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("newdimensions:diamond_dimension_biome"));
			}
		}
	}
	@Override
