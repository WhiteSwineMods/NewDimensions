...
public class Birch_WoodShovelItem extends NewdimensionsModElements.ModElement {
	@ObjectHolder("newdimensions:birch_wood_shovel")
	public static final Item block = null;
	public Birch_WoodShovelItem(NewdimensionsModElements instance) {
		super(instance, 145);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("birch_wood_shovel"));
	}
}
