...
public class Birch_PlanksArmorItem extends NewdimensionsModElements.ModElement {
	@ObjectHolder("newdimensions:birch_planks_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("newdimensions:birch_planks_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("newdimensions:birch_planks_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("newdimensions:birch_planks_armor_boots")
	public static final Item boots = null;
	public Birch_PlanksArmorItem(NewdimensionsModElements instance) {
		super(instance, 82);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(NewDimensionsItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "newdimensions:textures/models/armor/birch_planks_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("birch_planks_armor_helmet"));
		...
		}.setRegistryName("birch_planks_armor_chestplate"));
		...
		}.setRegistryName("birch_planks_armor_leggings"));
		...
		}.setRegistryName("birch_planks_armor_boots"));
	}
}
