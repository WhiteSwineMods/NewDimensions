...
public class Oak_WoodArmorItem extends NewdimensionsModElements.ModElement {
	@ObjectHolder("newdimensions:oak_wood_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("newdimensions:oak_wood_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("newdimensions:oak_wood_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("newdimensions:oak_wood_armor_boots")
	public static final Item boots = null;
	public Oak_WoodArmorItem(NewdimensionsModElements instance) {
		super(instance, 42);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(NewDimensionsItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "newdimensions:textures/models/armor/oak_wood_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("oak_wood_armor_helmet"));
		...
		}.setRegistryName("oak_wood_armor_chestplate"));
		...
		}.setRegistryName("oak_wood_armor_leggings"));
		...
		}.setRegistryName("oak_wood_armor_boots"));
	}
}
