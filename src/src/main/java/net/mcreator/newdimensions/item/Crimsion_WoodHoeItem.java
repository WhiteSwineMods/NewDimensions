...
public class Crimsion_WoodHoeItem extends NewdimensionsModElements.ModElement {
	@ObjectHolder("newdimensions:crimsion_wood_hoe")
	public static final Item block = null;
	public Crimsion_WoodHoeItem(NewdimensionsModElements instance) {
		super(instance, 186);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("crimsion_wood_hoe"));
	}
}
