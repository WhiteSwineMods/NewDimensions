...
public class Jungle_WoodSwordItem extends NewdimensionsModElements.ModElement {
	@ObjectHolder("newdimensions:jungle_wood_sword")
	public static final Item block = null;
	public Jungle_WoodSwordItem(NewdimensionsModElements instance) {
		super(instance, 154);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("jungle_wood_sword"));
	}
}
