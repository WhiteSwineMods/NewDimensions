...
public class DirtArmorArmorItem extends NewdimensionsModElements.ModElement {
	@ObjectHolder("newdimensions:dirt_armor_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("newdimensions:dirt_armor_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("newdimensions:dirt_armor_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("newdimensions:dirt_armor_armor_boots")
	public static final Item boots = null;
	public DirtArmorArmorItem(NewdimensionsModElements instance) {
		super(instance, 6);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(NewDimensionsItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "newdimensions:textures/models/armor/dirtarmor_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("dirt_armor_armor_helmet"));
		...
		}.setRegistryName("dirt_armor_armor_chestplate"));
		...
		}.setRegistryName("dirt_armor_armor_leggings"));
		...
		}.setRegistryName("dirt_armor_armor_boots"));
	}
}
