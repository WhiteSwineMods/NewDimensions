...
import net.mcreator.newdimensions.item.DiamondDimensionItem;
...
public class DiamondDimensionDimension extends NewdimensionsModElements.ModElement {
	@ObjectHolder("newdimensions:diamond_dimension_portal")
	public static final CustomPortalBlock portal = null;
	public DiamondDimensionDimension(NewdimensionsModElements instance) {
		super(instance, 33);
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("newdimensions:diamond_dimension"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("diamond_dimension_portal", Vector3i::compareTo, 300);
	public static class POIRegisterHandler {
		...
		public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
			poi = new PointOfInterestType("diamond_dimension_portal",
	...
	public void initElements() {
		...
		elements.items.add(() -> new DiamondDimensionItem().setRegistryName("diamond_dimension"));
	}
			...
			if (!entity.isPassenger() && !entity.isBeingRidden() && entity.isNonBoss() && !entity.world.isRemote && true) {
				if (entity.func_242280_ah()) {
					entity.func_242279_ag();
						...
						new ResourceLocation("newdimensions:diamond_dimension"))) {
					entity.func_242279_ag();
					teleportToDimension(entity, pos,
							RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("newdimensions:diamond_dimension")));
				} else {
					entity.func_242279_ag();
