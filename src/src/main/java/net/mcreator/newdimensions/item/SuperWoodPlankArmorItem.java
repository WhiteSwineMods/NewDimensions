...
public class SuperWoodPlankArmorItem extends NewdimensionsModElements.ModElement {
	@ObjectHolder("newdimensions:super_wood_plank_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("newdimensions:super_wood_plank_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("newdimensions:super_wood_plank_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("newdimensions:super_wood_plank_armor_boots")
	public static final Item boots = null;
	public SuperWoodPlankArmorItem(NewdimensionsModElements instance) {
		super(instance, 220);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(NewDimensionsItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "newdimensions:textures/models/armor/superwoodplank_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("super_wood_plank_armor_helmet"));
		...
		}.setRegistryName("super_wood_plank_armor_chestplate"));
		...
		}.setRegistryName("super_wood_plank_armor_leggings"));
		...
		}.setRegistryName("super_wood_plank_armor_boots"));
	}
}
