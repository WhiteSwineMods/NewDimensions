...
public class Oak_WoodPickaxeItem extends NewdimensionsModElements.ModElement {
	@ObjectHolder("newdimensions:oak_wood_pickaxe")
	public static final Item block = null;
	public Oak_WoodPickaxeItem(NewdimensionsModElements instance) {
		super(instance, 122);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("oak_wood_pickaxe"));
	}
}
