...
public class WoodDimensionBiomeBiome extends NewdimensionsModElements.ModElement {
	public static Biome biome;
	public WoodDimensionBiomeBiome(NewdimensionsModElements instance) {
		super(instance, 39);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("newdimensions:wood_dimension_biome"));
			}
		}
	}
	@Override
