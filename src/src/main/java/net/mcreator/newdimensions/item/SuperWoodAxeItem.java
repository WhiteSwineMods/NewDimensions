...
public class SuperWoodAxeItem extends NewdimensionsModElements.ModElement {
	@ObjectHolder("newdimensions:super_wood_axe")
	public static final Item block = null;
	public SuperWoodAxeItem(NewdimensionsModElements instance) {
		super(instance, 241);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("super_wood_axe"));
	}
}
