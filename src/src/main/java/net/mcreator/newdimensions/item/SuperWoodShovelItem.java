...
public class SuperWoodShovelItem extends NewdimensionsModElements.ModElement {
	@ObjectHolder("newdimensions:super_wood_shovel")
	public static final Item block = null;
	public SuperWoodShovelItem(NewdimensionsModElements instance) {
		super(instance, 243);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("super_wood_shovel"));
	}
}
