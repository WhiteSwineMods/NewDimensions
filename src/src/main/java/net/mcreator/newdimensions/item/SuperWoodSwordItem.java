...
public class SuperWoodSwordItem extends NewdimensionsModElements.ModElement {
	@ObjectHolder("newdimensions:super_wood_sword")
	public static final Item block = null;
	public SuperWoodSwordItem(NewdimensionsModElements instance) {
		super(instance, 242);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("super_wood_sword"));
	}
}
