...
public class Jungle_PlankArmorItem extends NewdimensionsModElements.ModElement {
	@ObjectHolder("newdimensions:jungle_plank_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("newdimensions:jungle_plank_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("newdimensions:jungle_plank_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("newdimensions:jungle_plank_armor_boots")
	public static final Item boots = null;
	public Jungle_PlankArmorItem(NewdimensionsModElements instance) {
		super(instance, 87);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(NewDimensionsItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "newdimensions:textures/models/armor/jungle_plank_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("jungle_plank_armor_helmet"));
		...
		}.setRegistryName("jungle_plank_armor_chestplate"));
		...
		}.setRegistryName("jungle_plank_armor_leggings"));
		...
		}.setRegistryName("jungle_plank_armor_boots"));
	}
}
