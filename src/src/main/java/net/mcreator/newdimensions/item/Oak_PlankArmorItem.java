...
public class Oak_PlankArmorItem extends NewdimensionsModElements.ModElement {
	@ObjectHolder("newdimensions:oak_plank_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("newdimensions:oak_plank_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("newdimensions:oak_plank_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("newdimensions:oak_plank_armor_boots")
	public static final Item boots = null;
	public Oak_PlankArmorItem(NewdimensionsModElements instance) {
		super(instance, 72);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(NewDimensionsItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "newdimensions:textures/models/armor/oak_plank_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("oak_plank_armor_helmet"));
		...
		}.setRegistryName("oak_plank_armor_chestplate"));
		...
		}.setRegistryName("oak_plank_armor_leggings"));
		...
		}.setRegistryName("oak_plank_armor_boots"));
	}
}
