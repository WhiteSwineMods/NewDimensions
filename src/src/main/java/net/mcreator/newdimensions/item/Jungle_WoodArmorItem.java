...
public class Jungle_WoodArmorItem extends NewdimensionsModElements.ModElement {
	@ObjectHolder("newdimensions:jungle_wood_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("newdimensions:jungle_wood_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("newdimensions:jungle_wood_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("newdimensions:jungle_wood_armor_boots")
	public static final Item boots = null;
	public Jungle_WoodArmorItem(NewdimensionsModElements instance) {
		super(instance, 57);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(NewDimensionsItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "newdimensions:textures/models/armor/jungle_wood_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("jungle_wood_armor_helmet"));
		...
		}.setRegistryName("jungle_wood_armor_chestplate"));
		...
		}.setRegistryName("jungle_wood_armor_leggings"));
		...
		}.setRegistryName("jungle_wood_armor_boots"));
	}
}
