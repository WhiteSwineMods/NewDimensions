...
public class Oak_WoodHoeItem extends NewdimensionsModElements.ModElement {
	@ObjectHolder("newdimensions:oak_wood_hoe")
	public static final Item block = null;
	public Oak_WoodHoeItem(NewdimensionsModElements instance) {
		super(instance, 126);
	}
