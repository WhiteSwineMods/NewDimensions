...
public class SuperWoodHoeItem extends NewdimensionsModElements.ModElement {
	@ObjectHolder("newdimensions:super_wood_hoe")
	public static final Item block = null;
	public SuperWoodHoeItem(NewdimensionsModElements instance) {
		super(instance, 244);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("super_wood_hoe"));
	}
}
