...
public class DirtToolsAxeItem extends NewdimensionsModElements.ModElement {
	@ObjectHolder("newdimensions:dirt_tools_axe")
	public static final Item block = null;
	public DirtToolsAxeItem(NewdimensionsModElements instance) {
		super(instance, 17);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("dirt_tools_axe"));
	}
}
