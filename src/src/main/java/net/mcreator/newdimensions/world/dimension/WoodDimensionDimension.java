...
import net.mcreator.newdimensions.item.WoodDimensionItem;
...
public class WoodDimensionDimension extends NewdimensionsModElements.ModElement {
	@ObjectHolder("newdimensions:wood_dimension_portal")
	public static final CustomPortalBlock portal = null;
	public WoodDimensionDimension(NewdimensionsModElements instance) {
		super(instance, 40);
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("newdimensions:wood_dimension"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("wood_dimension_portal", Vector3i::compareTo, 300);
	public static class POIRegisterHandler {
		...
		public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
			poi = new PointOfInterestType("wood_dimension_portal", Sets.newHashSet(ImmutableSet.copyOf(portal.getStateContainer().getValidStates())),
	...
	public void initElements() {
		...
		elements.items.add(() -> new WoodDimensionItem().setRegistryName("wood_dimension"));
	}
			...
			if (!entity.isPassenger() && !entity.isBeingRidden() && entity.isNonBoss() && !entity.world.isRemote && true) {
				if (entity.func_242280_ah()) {
					entity.func_242279_ag();
						...
						new ResourceLocation("newdimensions:wood_dimension"))) {
					entity.func_242279_ag();
					teleportToDimension(entity, pos,
							RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("newdimensions:wood_dimension")));
				} else {
					entity.func_242279_ag();
