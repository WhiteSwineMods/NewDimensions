...
public class StoneDimesnionBiomeBiome extends NewdimensionsModElements.ModElement {
	public static Biome biome;
	public StoneDimesnionBiomeBiome(NewdimensionsModElements instance) {
		super(instance, 4);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("newdimensions:stone_dimesnion_biome"));
			}
		}
	}
	@Override
