...
public class Spruce_WoodHoeItem extends NewdimensionsModElements.ModElement {
	@ObjectHolder("newdimensions:spruce_wood_hoe")
	public static final Item block = null;
	public Spruce_WoodHoeItem(NewdimensionsModElements instance) {
		super(instance, 136);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("spruce_wood_hoe"));
	}
}
