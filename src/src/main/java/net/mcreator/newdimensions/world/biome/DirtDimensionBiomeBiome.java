...
public class DirtDimensionBiomeBiome extends NewdimensionsModElements.ModElement {
	public static Biome biome;
	public DirtDimensionBiomeBiome(NewdimensionsModElements instance) {
		super(instance, 2);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("newdimensions:dirt_dimension_biome"));
			}
		}
	}
	@Override
