...
public class IronDimesnionBiomeBiome extends NewdimensionsModElements.ModElement {
	public static Biome biome;
	public IronDimesnionBiomeBiome(NewdimensionsModElements instance) {
		super(instance, 26);
			...
			if (biome == null) {
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(Blocks.IRON_BLOCK.getDefaultState()),
								new SimpleBlockStateProvider(Blocks.IRON_BARS.getDefaultState()),
				...
				event.getRegistry().register(biome.setRegistryName("newdimensions:iron_dimesnion_biome"));
			}
		}
	}
	@Override
