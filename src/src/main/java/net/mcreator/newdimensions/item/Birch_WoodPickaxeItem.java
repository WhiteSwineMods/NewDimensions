...
public class Birch_WoodPickaxeItem extends NewdimensionsModElements.ModElement {
	@ObjectHolder("newdimensions:birch_wood_pickaxe")
	public static final Item block = null;
	public Birch_WoodPickaxeItem(NewdimensionsModElements instance) {
		super(instance, 142);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("birch_wood_pickaxe"));
	}
}
