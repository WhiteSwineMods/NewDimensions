...
public class Spruce_WoodAxeItem extends NewdimensionsModElements.ModElement {
	@ObjectHolder("newdimensions:spruce_wood_axe")
	public static final Item block = null;
	public Spruce_WoodAxeItem(NewdimensionsModElements instance) {
		super(instance, 133);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("spruce_wood_axe"));
	}
}
