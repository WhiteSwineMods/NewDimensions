...
public class Birch_WoodHoeItem extends NewdimensionsModElements.ModElement {
	@ObjectHolder("newdimensions:birch_wood_hoe")
	public static final Item block = null;
	public Birch_WoodHoeItem(NewdimensionsModElements instance) {
		super(instance, 146);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("birch_wood_hoe"));
	}
}
